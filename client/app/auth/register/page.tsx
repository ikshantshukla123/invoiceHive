...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      <header className="h-20 fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-outline-variant/10">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 h-20">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg primary-gradient flex items-center justify-center"><Zap className="w-4 h-4 text-white fill-white" /></div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/auth/login" className="text-primary font-semibold text-sm hover:opacity-80 transition-all">Sign In</Link>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow flex items-center justify-center px-6 pt-24 pb-12">
        <div className="w-full max-w-xl">
          <div className="relative">
            ...
            <div className="absolute -bottom-12 -right-12 w-64 h-64 bg-tertiary/5 rounded-full blur-3xl pointer-events-none" />
            <div className="relative card overflow-hidden">
              <div className="p-8 md:p-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                  <a href={`${API}/auth/oauth/google`} className="flex items-center justify-center gap-3 px-6 py-3 border border-outline-variant/20 rounded-xl bg-surface-container-lowest text-on-surface font-semibold text-sm hover:bg-surface-container-low transition-colors">
                  ...
                  <a href={`${API}/auth/oauth/github`} className="flex items-center justify-center gap-3 px-6 py-3 border border-outline-variant/20 rounded-xl bg-surface-container-lowest text-on-surface font-semibold text-sm hover:bg-surface-container-low transition-colors">
                ...
                <div className="relative mb-8">
                  ...
                  <div className="relative flex justify-center text-xs"><span className="px-4 bg-surface-container-lowest text-on-surface-variant uppercase tracking-widest">Or continue with email</span></div>
                </div>
