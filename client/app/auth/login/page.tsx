          ...
          <div className="w-full max-w-[400px]">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-4 text-outline font-medium uppercase tracking-widest">or continue with</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <a href={`${API}/auth/oauth/google`} className="flex items-center justify-center gap-3 h-12 border border-outline-variant/20 rounded-xl bg-white text-on-surface">
              ...
              <a href={`${API}/auth/oauth/github`} className="flex items-center justify-center gap-3 h-12 border border-outline-variant/20 rounded-xl bg-white text-on-surface">
