  ...
  if (!token) {
    return (
      <div className="text-center">
        ...
        <Link href="/auth/forgot-password" className="btn-primary w-full h-12 justify-center text-base">Request new link</Link>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button type="submit" disabled={loading} className="btn-primary w-full h-12 justify-center text-base mt-2">
          {loading ? (
